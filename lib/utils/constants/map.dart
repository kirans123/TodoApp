...
import 'package:login_and_registration/utils/constants/conversion.dart';
...
extension MapExtensions on Map {
  ...
  bool getBool(String key, {bool defaultValue = defaultBool}) {
    ...
    logger.e("Map.getBool[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  int getInt(String key, {int defaultValue = defaultInt}) {
    ...
    logger.e("Map.getInt[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  double getDouble(String key, {double defaultValue = defaultDouble}) {
    ...
    logger.e("Map.getDouble[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  String getString(String key, {String defaultValue = defaultString}) {
    ...
    logger.e("Map.getString[$key] has incorrect data : ${this[key]}");
    return defaultValue;
  }
  ...
  Map getMap(String key) {
    ...
    logger.e("Map.getMap[$key] has incorrect data :  ${this[key]}");
    return defaultMap;
  }
